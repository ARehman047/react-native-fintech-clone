  ...
  if (id === 'spent') {
    return (
      <View style={styles.container} pointerEvents="none">
        ...
        <Text style={{ color: '#b5109c', fontWeight: 'bold', fontSize: 26, paddingTop: 10 }}>
          1024€
        </Text>
      </View>
    );
        ...
        <View style={{ alignItems: 'center', justifyContent: 'center', gap: 10 }}>
          <View
            style={{
              ...
              width: 60,
              borderRadius: 30,
              backgroundColor: '#1b15bf',
              alignItems: 'center',
              justifyContent: 'center',
            }}>
            <Text style={{ color: '#fff', fontWeight: 'bold', fontSize: 18 }}>5%</Text>
          </View>
          <Text style={{ color: '#1b15bf', fontWeight: 'bold', fontSize: 18 }}>Cashback</Text>
        </View>
      </View>
    );
  }
